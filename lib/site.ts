...
export const whyChoose = [
  ...
  { icon: "pin", title: "7 clinics near you", text: "Conveniently located inside trusted medical practices across the Hunter Region." },
...
export const team: TeamMember[] = [
  ...
  {
    slug: "zarqa-shariff", name: "Zarqa Shariff", role: "Senior Physiotherapist", photo: "/team/zarqa-shariff.jpg",
    bio: [
      "Zarqa focuses on women's health, clinical Pilates and post-operative rehabilitation, with a strong interest in supporting patients through structured, long-term recovery.",
      "Her approach combines evidence-based treatment with personalised programs designed to improve movement, build strength and restore confidence. She works closely with each patient to ensure care is practical, goal-oriented and sustainable.",
    ],
    interests: ["Women's Health", "Clinical Pilates", "Post-Operative Rehab"],
  },
  {
  ...
  {
    slug: "jason-lau", name: "Jason Lau", role: "Physiotherapist", photo: "/team/jason-lau.jpg",
    bio: [
      "Jason is a physiotherapist who graduated from the University of Newcastle (UON) in 2025. He focuses on the assessment and treatment of a wide range of musculoskeletal conditions, including acute injuries, post-operative rehabilitation, chronic pain and sports-related issues.",
      "He uses evidence-based techniques and works closely with patients to support their recovery goals. Outside the clinic, Jason enjoys walking along the beaches, scenic drives and fishing.",
    ],
    interests: ["Musculoskeletal", "Acute Injuries", "Sports"],
  },
];
...
export const faqs: Faq[] = [
  ...
  { q: "Where are your clinics?", a: "We have clinics inside trusted medical practices at Mount Hutton, Wallsend, Warners Bay, Rutherford, Muswellbrook, Salamander Bay and Revesby — across the Hunter Region." },
